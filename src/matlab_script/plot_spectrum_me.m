...
% ---------------------------------------------------------------
timestamp_foldern='DAE_C_2022_0117_1238_28'; % log 下 時戳資料夾名
%
...
s1_path=fullfile(prj_path,'MFA_DAE_ME','src','log',timestamp_foldern,'test_source1');
s2_path=fullfile(prj_path,'MFA_DAE_ME','src','log',timestamp_foldern,'test_source2');
